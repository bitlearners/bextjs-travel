            ...
            {expandedMenu === 'blogs' && (
              <div className="translate transform overflow-hidden">
                <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                  <li>
                    <Link href={adminUrl + "/blogs"} className="py-3">
                      <p
                        className={
                          currentPath === adminUrl + "/blogs"
                            ? "text-[#8576FF] font-semibold bg-gray-100 flex items-center p-2 rounded-lg hover:bg-gray-100"
                            : "flex items-center p-2 rounded-lg text-gray-100 hover:text-[#8576FF] hover:bg-gray-100"
                        }
                      >
                  ...
                  <li>
                    <Link href={adminUrl + "/blogs/add"} className="py-3">
                      <p
                        className={
                          currentPath === adminUrl + "/blogs/add"
                            ? "text-[#8576FF] font-semibold bg-gray-100 flex items-center p-2 rounded-lg hover:bg-gray-100"
                            : "flex items-center p-2 rounded-lg text-gray-100 hover:text-[#8576FF] hover:bg-gray-100"
                        }
                      >
                        <span className="ms-3">Add New Blog</span>
                      </p>
                    </Link>
                  </li>
                </ul>
